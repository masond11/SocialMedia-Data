...
/**
 * This class tests the CompareByReachQuarter class
 * 
 * @author Mason Dooley
 * @version 2022.11.29
 *
 */
public class CompareByReachQuarterTest extends TestCase {

    //Fields
    private CompareByReachQuarter comparator;
     ...
     */
    public void setUp() {
        comparator = new CompareByReachQuarter();
